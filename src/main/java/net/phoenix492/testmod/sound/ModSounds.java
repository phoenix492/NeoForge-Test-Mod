package net.phoenix492.testmod.sound;
...
public class ModSounds {
    ...
    public static final Supplier<SoundEvent> CHISEL_USED = registerSoundEvent("chisel_used");
    ...
    private static ResourceKey<JukeboxSong> createSong(String name) {
        return ResourceKey.create(Registries.JUKEBOX_SONG, ResourceLocation.fromNamespaceAndPath(TestMod.MODID, name));
    }

    private static Supplier<SoundEvent> registerSoundEvent(String name) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(TestMod.MODID, name);
