package net.phoenix492.testmod.datagen.bootstrappers.worldgen;
...
import net.phoenix492.testmod.util.ModOrePlacement;
...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(
            context,
            BISMUTH_ORE_PLACED_KEY,
            configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_BISMUTH_ORE_KEY),
            ModOrePlacement.commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80)))
        );

        register(
            context,
            NETHER_BISMUTH_ORE_PLACED_KEY,
