package net.phoenix492.testmod.datagen.bootstrappers;
...
public class ModEnchantments {
    ...
    public static final ResourceKey<Enchantment> LIGHTNING_STRIKER = ResourceKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath(TestMod.MODID, "lightning_striker"));
